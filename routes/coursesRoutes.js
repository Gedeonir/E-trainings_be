...
const { getAllCourses, addNewCourse,getOneCourse, filterByPopularity, deleteCourse } = require("../controller/CourseCtrl");
...
router.delete("/:id",authMiddlewareAdmin,deleteCourse);
